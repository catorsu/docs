...
This ensures that a value matches the most recent [snapshot](https://jestjs.io/docs/snapshot-testing). Check out the [Snapshot Testing guide](https://jestjs.io/docs/snapshot-testing) for more information.
...
Check out [React Tree Snapshot Testing](https://jestjs.io/docs/snapshot-testing#react-tree-snapshot-testing) for more information on snapshot testing.
...
Expected value to be (using Object.is): "banana"
Received: "apple"
```
...
it('transitions as expected', () => {
  ...
  transition(); // Already produces a mismatch. No point in continuing the test.
